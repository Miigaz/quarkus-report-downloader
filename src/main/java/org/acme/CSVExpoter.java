...
public class CSVExpoter {
    ...
    public List<Map<String, Object>> getData(AgroalDataSource dataSource, int rowStart, int rowEnd, String beginDate, String endDate) throws Exception {
        ...
        try {
            ...
            callableStatement = connection.prepareCall("{ call pk_adminpanel.extra_purchased_list(?,?,?,?,?,?,?,?,?) } ");

            try {
                callableStatement.setString(1, "id");
                callableStatement.setString(2, "ASC");
                callableStatement.setLong(3, rowStart);
                callableStatement.setLong(4, rowEnd);
                callableStatement.setString(5, beginDate);
